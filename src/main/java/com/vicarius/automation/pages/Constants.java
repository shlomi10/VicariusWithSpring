...
public class Constants {
    ...
    public static List<String> expectedFeatures = List.of("Full-featured 30-day trial", "Risk reduction from Day 1", "Unified platform", "5 minutes set-up and deployment");
    ...
    public static List<String> expectedLinks = List.of("https://www.vicarius.io/product", "https://www.vicarius.io/product/vulnerability-management", "https://www.vicarius.io/product/patch-management",
            ...
            "https://www.vicarius.io/competitors/topia-vs-automox", "https://www.vicarius.io/competitors/topia-vs-manageengine", "https://www.vicarius.io/competitors/topia-vs-rapid7",
            "https://www.vicarius.io/competitors/topia-vs-tenable", "https://www.vicarius.io/competitors/topia-vs-nessus", "https://www.vicarius.io/competitors/topia-vs-tanium",
    ...
    public static String errorMissingFieldText = "Field is required.";
    public static String errorEmailTextField = "Must be valid email address.";
